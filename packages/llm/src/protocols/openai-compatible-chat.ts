 ...
 *  `/chat/completions` endpoint. Reuses `OpenAIChat.protocol` end-to-end and overrides only
 *  the route id, so providers resolve per-family without colliding with native OpenAI. */
