...
Schema-first LLM core for origami. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@origami/llm"
import { OpenAI } from "@origami/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@origami/llm/providers"
