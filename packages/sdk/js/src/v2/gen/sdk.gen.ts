...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new OrigamiClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Origami system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Origami system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Origami server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Origami state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Origami configuration settings and preferences.
   */
   ...
   *
   * Update global Origami configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Origami server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Origami system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Origami instances, releasing all resources.
   */
   ...
   * Upgrade origami
   *
   * Upgrade origami to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Origami configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Origami configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
  ...
  public refresh<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ConfigRefreshResponses, ConfigRefreshErrors, ThrowOnError>({
      url: "/config/refresh",
      ...options,
      ...params,
    })
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Origami instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Origami system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Origami.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Origami is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Origami.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Origami sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Origami session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Origami session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Origami process. Idle interruption is a no-op.
   */
...
export class OrigamiClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<OrigamiClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    OrigamiClient.__registry.set(this, args?.key)
  }
