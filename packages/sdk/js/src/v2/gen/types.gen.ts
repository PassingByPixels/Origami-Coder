...
/**
 * Server configuration for origami serve and web commands
 */
...
export type ConfigRefreshErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ConfigRefreshError = ConfigRefreshErrors[keyof ConfigRefreshErrors]

export type ConfigRefreshResponses = {
  /**
   * Config caches invalidated + instance reloaded
   */
  200: boolean
}

export type ConfigRefreshResponse = ConfigRefreshResponses[keyof ConfigRefreshResponses]
