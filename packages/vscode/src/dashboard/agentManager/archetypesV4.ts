// FROZEN generation-4 archetype payloads - the six files Origami Code 0.4.138 shipped,
// before t-f3a74m gave every archetype the owner-approved default tool matrix. Its own
// file rather than more surface on archetypesLegacy.ts, which is capped and equally frozen.
// DO NOT EDIT: an edit here would strand real 0.4.x installs as falsely user-edited, and
// the subagent-tools-v1 sweep would then refuse to reconcile them.

export const ARCHETYPES_V4: Array<{ file: string; content: string }> = [
  {
    file: 'architect.md',
    content: `---
