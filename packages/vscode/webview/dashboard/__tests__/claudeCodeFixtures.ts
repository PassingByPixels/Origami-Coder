...
//
// One exception, made for the public source: the account e-mail and
// organisation, one private skill description, and the private skill, command
// and MCP server names are replaced with neutral values. The replacement is
...
export const RUN1_SYSTEM_INIT =
  "{\"type\":\"system\",\"subtype\":\"init\",\"cwd\":\"C:\\\\Users\\\\dev\\\\AppData\\\\Local\\\\Temp\\\\claude\\\\c--Users-dev-Desktop-Workspace\\\\86d82c38-23ee-4d0d-87e9-b6a9d26d7537\\\\scratchpad\\\\spike\\\\cwd\",\"session_id\":\"c6bab4a9-9d8a-4bf1-855d-9d7e146f884a\",\"tools\":[\"Task\",\"AskUserQuestion\",\"Bash\"],\"mcp_servers\":[{\"name\":\"blender\",\"status\":\"pending\"},{\"name\":\"board\",\"status\":\"pending\"}],\"model\":\"claude-haiku-4-5-20251001\",\"permissionMode\":\"default\",\"slash_commands\":[\"make-asset\",\"delegate\",\"fable-mode\"],\"apiKeySource\":\"none\",\"claude_code_version\":\"2.1.198\",\"output_style\":\"default\",\"agents\":[\"AI Engineer\",\"claude\",\"Embedded Firmware Engineer\"],\"skills\":[\"make-asset\",\"delegate\",\"fable-mode\"],\"plugins\":[],\"analytics_disabled\":false,\"product_feedback_disabled\":false,\"uuid\":\"57b39cda-c4d2-4e47-93f8-cfdeeb45c35e\",\"memory_paths\":{\"auto\":\"C:\\\\Users\\\\dev\\\\.claude\\\\memory\\\\\"},\"fast_mode_state\":\"off\"}";
...
export const PROBE_INITIALIZE_RESPONSE =
  "{\"type\":\"control_response\",\"response\":{\"subtype\":\"success\",\"request_id\":\"x_1\",\"response\":{\"commands\":[{\"name\":\"make-asset\",\"description\":\"Create one game asset (a prop, weapon or piece of armour) through a browser review tool: you start it once, then the user approves each stage (images, mesh, cleanup, export) in a review page that refreshes itself. You only step in again to debug a failed stage. Use when the user asks to make an asset. (user)\",\"argumentHint\":\"<what to make, e.g. 'a rusted iron helmet'>\"},{\"name\":\"delegate\",\"description\":\"Delegation + cost policy \u2014 Fable orchestrates, Opus heavy, Sonnet standard; local AIs are separate workflows, never delegation targets. Invoke BEFORE farming work to subagents or workflows, when planning multi-agent work, or when asked for a \\\"cost report\\\" / token split. Defines the end-of-session cost receipt. (user)\",\"argumentHint\":\"\"},{\"name\":\"fable-mode\",\"description\":\"fable mode / fable-mode \u2014 five-gate working discipline (Scope, Evidence, Attack, Verify, Report) for any model tier. Invoke ONLY on explicit request \u2014 when the user says \\\"fable mode\\\" or types /fable-mode, or when a delegation/handoff prompt explicitly names the fable-mode skill. Do NOT auto-load for ordinary implementation, debugging, or analysis tasks that don't mention it. (user)\",\"argumentHint\":\"\"}],\"agents\":[{\"name\":\"AI Engineer\",\"description\":\"Expert AI/ML engineer specializing in machine learning model development, deployment, and integration into production systems. Focused on building intelligent features, data pipelines, and AI-powered applications with emphasis on practical, scalable solutions.\"}],\"output_style\":\"default\",\"available_output_styles\":[\"default\",\"Proactive\",\"Explanatory\",\"Learning\"],\"models\":[{\"value\":\"default\",\"resolvedModel\":\"claude-opus-4-8[1m]\",\"displayName\":\"Default (recommended)\",\"description\":\"Opus 4.8 with 1M context \u00b7 Best for everyday, complex tasks\",\"supportsEffort\":true,\"supportedEffortLevels\":[\"low\",\"medium\",\"high\",\"xhigh\",\"max\"],\"supportsAdaptiveThinking\":true,\"supportsFastMode\":true,\"supportsAutoMode\":true}],\"pid\":9572,\"feedback_survey_config\":{\"minTimeBeforeFeedbackMs\":300000,\"minTimeBetweenFeedbackMs\":3600000,\"minTimeBetweenGlobalFeedbackMs\":43200000,\"minUserTurnsBeforeFeedback\":3,\"minUserTurnsBetweenFeedback\":5,\"hideThanksAfterMs\":3000,\"onForModels\":[\"*\"],\"probability\":0.25,\"lastSurveyShownTime\":1788164188699}}}}";
