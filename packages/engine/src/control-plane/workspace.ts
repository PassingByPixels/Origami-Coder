...
import { EventSequenceTable, EventTable } from "@origami/core/event/sql"
...
import { WorkspaceEvent } from "@origami/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@origami/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ORIGAMI_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ORIGAMI_WORKSPACE_ID: config.id,
        ORIGAMI_EXPERIMENTAL_WORKSPACES: "true",
