 ...
 *   "@origami/ServerAuthConfig",
 *   {
 *     password: Config.string("ORIGAMI_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ORIGAMI_SERVER_USERNAME").pipe(Config.withDefault("origami")),
 *   },
 * ) {}
 *
