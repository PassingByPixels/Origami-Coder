...
import { createOrigamiClient } from "@origami/sdk"
...
import { InstallationChannel } from "@origami/core/installation/version"
...
function internalPlugins(flags: RuntimeFlags.Info): PluginInstance[] {
  return [
    ...
    // whose Plugin type is nominally distinct from this fork's @origami/plugin. Bridge with a cast (matches master).
