...
import { makeApi } from "@origami/protocol/api"
import { LocationMiddleware } from "@origami/server/location"
import { SessionLocationMiddleware } from "@origami/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("origami-root")
...
export const InstanceHttpApi = HttpApi.make("origami-instance")
...
export const OrigamiHttpApi = HttpApi.make("origami")
