...
>()("@origami/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@origami/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.ORIGAMI_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.ORIGAMI_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-origami-directory"] || process.cwd()
}
