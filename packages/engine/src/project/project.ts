...
import { ProjectDirectoryTable, ProjectTable } from "@origami/core/project/sql"
import { ProjectDirectories } from "@origami/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@origami/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ORIGAMI_FAKE_VCS)
