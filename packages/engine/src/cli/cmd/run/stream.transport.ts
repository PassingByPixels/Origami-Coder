...
import type { Event, GlobalEvent, OrigamiClient } from "@origami/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@origami/RunStreamTransport") {}
