...
import { openEditor } from "@origami/tui/editor"
import { registerOrigamiKeymap } from "@origami/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerOrigamiKeymap(keymap, renderer, input.tuiConfig)
