...
//
// The saved variant persists across sessions in ~/.local/state/origami/model.json
...
class Service extends Context.Service<Service, VariantService>()("@origami/RunVariant") {}
