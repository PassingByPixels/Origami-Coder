...
export function createAcpClient(input: Pick<CliFixture, "origami">, env?: Record<string, string>) {
  return Effect.gen(function* () {
    return createJsonRpcAcpClient(yield* input.origami.acp(env ? { env } : undefined))
  })
}
