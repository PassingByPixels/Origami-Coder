...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ORIGAMI_CALLER", () => {
    process.env["ORIGAMI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ORIGAMI_CALLER", () => {
    process.env["ORIGAMI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ORIGAMI_CALLER", () => {
    process.env["ORIGAMI_CALLER"] = "unknown"
