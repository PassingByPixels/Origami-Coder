...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips origami-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-origami-directory"]).toBeUndefined()
      expect(forwarded["x-origami-workspace"]).toBeUndefined()
