...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips origami-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-origami-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-origami-directory")).toBeNull()
      expect(result.get("x-origami-workspace")).toBeNull()
