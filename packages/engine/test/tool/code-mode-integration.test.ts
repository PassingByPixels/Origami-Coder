...
import { Server, InMemoryTransport, LATEST_PROTOCOL_VERSION } from "@modelcontextprotocol/server"
import type { CallToolResult, Tool as MCPToolDef } from "@modelcontextprotocol/server"
