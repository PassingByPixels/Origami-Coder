...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "ORIGAMI.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/engine/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/engine (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/engine/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/engine/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const ORIGAMI_DB|ORIGAMI_DB|ORIGAMI_DEV|Global\\.Path\\.data|data =" in packages/engine/src (115 matches)',
  },
] as const
