...
import { useBindings, useOrigamiModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useOrigamiModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.ORIGAMI_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
