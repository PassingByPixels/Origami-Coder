...
import { ORIGAMI_BASE_MODE, useBindings, useCommandShortcut, useOrigamiKeymap } from "../../keymap"
import { usePathFormatter } from "../../context/path-format"
import { LocationProvider } from "../../context/location"

// FORK STRIP: tree-sitter grammar registration gated OFF by default — the URLs
// in parsers-config.ts are lazy-fetched from GitHub by opentui when a filetype
// needs highlighting (the last ungated egress). The opentui built-in parsers
// (markdown/js/ts) ship in the bundle and are unaffected; exotic-filetype
// highlighting in the TUI degrades gracefully. Re-enable the downloads with
// ORIGAMI_DISABLE_GRAMMAR_DOWNLOAD=false.
if (process.env["ORIGAMI_DISABLE_GRAMMAR_DOWNLOAD"] === "false") addDefaultParsers(parsers.parsers)
