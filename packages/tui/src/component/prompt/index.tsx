...
import { registerOrigamiSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@origami/sdk/v2"
...
import { ORIGAMI_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOrigamiKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.ORIGAMI_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
