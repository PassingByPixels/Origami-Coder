...
import defaultSoundPath from "@origami/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@origami/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@origami/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@origami/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@origami/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@origami/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "origami"
const DEFAULT_PACK_ID = "origami.default"
