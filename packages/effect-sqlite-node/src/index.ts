...
export const TypeId: TypeId = "~@origami/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@origami/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@origami/effect-sqlite-node/NodeSqliteClient")
