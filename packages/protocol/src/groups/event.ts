...
import type { Definition } from "@origami/schema/event"
...
export const OrigamiEvent = event.schema
export type OrigamiEvent = typeof OrigamiEvent.Type
export type OrigamiEventEncoded = typeof OrigamiEvent.Encoded
