...
- Effect plugins import `@origami/plugin/v2/effect`, not `@origami/core`.
- Public domain values use generated `@origami/sdk` types.
...
- Define `PluginHost` domain capabilities in `@origami/plugin/v2/effect`.
