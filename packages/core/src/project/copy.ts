...
import { Event } from "@origami/schema/project-directories"
import { ProjectCopy } from "@origami/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@origami/ProjectCopy") {}
