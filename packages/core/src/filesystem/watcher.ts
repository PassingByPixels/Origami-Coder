...
import { FileSystemWatcher } from "@origami/schema/filesystem-watcher"
...
declare const ORIGAMI_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof ORIGAMI_LIBC === "undefined" ? undefined : ORIGAMI_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@origami/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.ORIGAMI_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.ORIGAMI_EXPERIMENTAL_FILEWATCHER)) {
