...
export class Service extends Context.Service<Service, Interface>()("@origami/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.ORIGAMI_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
