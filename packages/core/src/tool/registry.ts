...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@origami/llm"
...
export class Service extends Context.Service<Service, Interface>()("@origami/v2/ToolRegistry") {}
