...
import { Durable } from "@origami/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@origami/schema/event").ID
export type { Data, Definition, Payload } from "@origami/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@origami/Event") {}
