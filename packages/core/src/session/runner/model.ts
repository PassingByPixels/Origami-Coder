...
import { type Model } from "@origami/llm"
import * as AnthropicMessages from "@origami/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@origami/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@origami/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@origami/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@origami/v2/SessionRunnerModel") {}
