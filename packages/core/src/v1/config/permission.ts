...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    // Tools an agent-plugins.org plugin supplied, targeted as `plugin:<name>:<tool>`.
    // The rest-record below would accept this key anyway; naming it here is what
    // puts it in the generated config docs, where a user can find it.
    plugin: Schema.optional(Rule),
  }),
