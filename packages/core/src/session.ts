...
import { ListAnchor } from "@origami/schema/session"
...
import { SessionDurable } from "@origami/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@origami/v2/Session") {}
