...
import { Entry, FileSystem, FindInput, Match } from "@origami/schema/filesystem"
export { Entry, Match, Submatch } from "@origami/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@origami/v2/FileSystem") {}
