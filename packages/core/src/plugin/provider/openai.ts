...
import type { IntegrationOAuthMethodRegistration } from "@origami/plugin/v2/effect/integration"
import { define } from "@origami/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `origami/${InstallationVersion}` }
}
