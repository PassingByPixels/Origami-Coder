...
// test/preload.ts pins ORIGAMI_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.ORIGAMI_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.ORIGAMI_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.ORIGAMI_MODELS_PATH = undefined
  Flag.ORIGAMI_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.ORIGAMI_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.ORIGAMI_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
