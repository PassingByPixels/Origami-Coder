...
import { Agent } from "@origami/schema/agent"
import { Location } from "@origami/schema/location"
import { Model } from "@origami/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@origami/schema/prompt"
import { Provider } from "@origami/schema/provider"
import { Project } from "@origami/schema/project"
import { ProjectDirectories } from "@origami/schema/project-directories"
import { PermissionV1 } from "@origami/schema/permission-v1"
import { Session } from "@origami/schema/session"
import { SessionInput } from "@origami/schema/session-input"
import { SessionMessage } from "@origami/schema/session-message"
import { Workspace } from "@origami/schema/workspace"
import { Command } from "@origami/schema/command"
import { Connection } from "@origami/schema/connection"
import { Credential } from "@origami/schema/credential"
import { FileSystem } from "@origami/schema/filesystem"
import { Integration } from "@origami/schema/integration"
import { LLM } from "@origami/schema/llm"
import { Permission } from "@origami/schema/permission"
import { Plugin } from "@origami/schema/plugin"
import { Pty } from "@origami/schema/pty"
import { Reference } from "@origami/schema/reference"
import { SessionTodo } from "@origami/schema/session-todo"
import { Skill } from "@origami/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@origami/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@origami/core/command"),
    import("@origami/core/integration/connection"),
    import("@origami/core/credential"),
    import("@origami/core/filesystem"),
    import("@origami/core/integration"),
    import("@origami/core/location"),
    import("@origami/llm"),
    import("@origami/core/permission"),
    import("@origami/core/v1/permission"),
    import("@origami/core/project/copy"),
    import("@origami/core/pty"),
    import("@origami/core/project/schema"),
    import("@origami/core/reference"),
    import("@origami/core/session/input"),
    import("@origami/core/session/message"),
    import("@origami/core/session/todo"),
    import("@origami/core/session/prompt"),
    import("@origami/core/skill"),
    import("@origami/core/v2-schema"),
    import("@origami/core/schema"),
    import("@origami/core/workspace"),
  ])
