...
import { ProviderPlugins } from "@origami/core/plugin/provider"
import { ZenmuxPlugin } from "@origami/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://origami.gratis/", "X-Title": "origami" })
