...
describe("public event manifest", () => {
  test("owns the complete public event surface", () => {
    // 55->58 / 85->88 / 32->35: the question.v2 trio (asked/replied/rejected)
    // joined the server surface with the provider-chain restore and the counts
    // here were never moved with it.
